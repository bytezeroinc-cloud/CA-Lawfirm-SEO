...
const services = [
  {
    ...
    title: 'Google, Bing & Meta — Fully Managed',
    desc: 'We manage paid campaigns across every major platform where potential clients are searching. AI-driven bidding, continuous creative testing, and full cross-channel budget allocation — all tied to case revenue, not vanity metrics.',
    includes: [
      'Google Search Ads — high-intent legal keywords',
      'Microsoft / Bing Ads — lower CPC, often overlooked legal traffic',
      'Google Performance Max & Display retargeting',
      'Meta Ads (Facebook/Instagram) for brand awareness & retargeting',
      'YouTube pre-roll for attorney brand building',
      'Negative keyword management & search term audits weekly',
    ],
    metric: '4.8x ROAS',
  ...
  },
  {
    ...
    title: 'Full-Funnel Attribution — Click to Case',
    desc: 'Every dollar you spend is tracked from keyword click through form fill, intake call, and signed retainer. You know which channel, which ad, and which keyword generated each case — so scaling decisions are data-driven, not guesswork.',
    includes: [
      'Google Analytics 4 (GA4) full setup & event tracking',
      'Google Ads conversion tracking — calls, forms, chats',
      'Bing Ads conversion & audience tracking',
      'Cross-channel dashboard: Google + Bing + Meta + email in one view',
      'Call tracking with keyword-level attribution (CallRail / WhatConverts)',
      'Monthly report: CPL, cost-per-case, ROAS by channel & campaign',
    ],
    metric: '$28k',
