...
const tools = [
  ...
  {
    name: 'Google & Bing Ads',
    tagline: 'Paid Search Management',
    desc: 'We manage both Google Ads and Microsoft Advertising (Bing) — because legal searchers on Bing are often older, higher-income, and convert at lower CPCs than Google.',
    useCase: 'Bing typically delivers 20–35% lower CPC for legal keywords',
    color: '#FBBF24',
    delay: 240,
  },
  {
    name: 'GA4 + CallRail',
    tagline: 'Measurement & Attribution',
    desc: 'GA4 tracks every digital touchpoint. CallRail adds keyword-level call attribution — so a phone call from a Bing ad is tied back to the exact search term that triggered it.',
    useCase: 'Every call, form, and chat mapped to its source keyword',
    color: '#818CF8',
    delay: 320,
  },
  {
